export const TOOL_OPTIONS = [
    ...
    { key: 'correct_email_classification', labelKey: 'Correct email classification' },
    ...
    { key: 'get_project_happiness', labelKey: 'Get project happiness' },
    ...
    { key: 'search_gmail', labelKey: 'Search emails' },
    { key: 'list_recent_chat_media', labelKey: 'List recent chat media' },
    { key: 'get_chat_attachment', labelKey: 'Get chat attachment' },
    { key: 'get_gmail_attachment', labelKey: 'Get email attachment' },
    { key: 'create_gmail_reply_draft', labelKey: 'Create email reply draft' },

...
import { findNodeHandle as findNodeHandleRN, NativeModules, Touchable, Platform } from 'react-native'
...
function transformIntoHandlerTags(handlerIDs) {
    ...
    return handlerIDs
        .map(handlerID => handlerIDToTag[handlerID] || (handlerID.current && handlerID.current._handlerTag) || -1)
...
export default function createHandler(
    ...
    class Handler extends React.Component {
        ...
        _attachGestureHandler = newViewTag => {
            ...
            // Alldone patch: pass the wrapper instance so the web module can reach
            // the event dispatchers (extra argument is ignored on native).
            RNGestureHandlerModule.attachGestureHandler(this._handlerTag, newViewTag, this)
        }

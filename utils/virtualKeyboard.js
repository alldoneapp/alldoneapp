...
export const startVirtualKeyboardViewport = ({ margin = KEYBOARD_REVEAL_MARGIN_PX } = {}) => {
    ...
    const syncViewport = () => {
        ...
        // Only when the shell itself was shrunk: if the browser resized the
        // layout viewport it is managing the scroll position itself, and zeroing
        // it would fight that.
        if (insetOpen) resetDocumentScrollForKeyboard()

...
const TASK_COMPLETION_TEMPLATE_SID = 'HX5f589b8ee276e26a3a169fa85d84b951'
...
function countEmojiCharacters(value) {
    ...
    for (let i = 0; i < chars.length; i++) {
        ...
        // Flag emojis are made from pairs of regional indicator symbols – count them once
...
class TwilioWhatsAppService {
    ...
    /**
     * Fetch a Twilio Message Resource by SID. Inbound WhatsApp reply webhooks
     * provide the quoted message SID, but not the quoted message body.
     *
     * @param {string} messageSid
     * @returns {Promise<Object>}
     */
    async fetchMessageBySid(messageSid) {
        ...
        return await client.messages(normalizedMessageSid).fetch()
    }

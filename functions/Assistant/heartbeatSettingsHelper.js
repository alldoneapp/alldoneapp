...
function buildHeartbeatSettingsContextMessage(assistant = {}, { projectId = null, userData = null } = {}) {
    ...
    return [
        ...
        `- Execution chance after the user has written in either daily chat that local day: ${settings.chancePercent}%`,
        `- Execution chance before the user has written in either daily chat that local day: ${settings.chanceNoReplyPercent}%`,

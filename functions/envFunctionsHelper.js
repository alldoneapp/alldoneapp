        ...
        if (fs.existsSync(envJsonPath)) {
            try {
                ...
                const jsonEnvFunctions = {
                    ...
                    REVENUECAT_WEBHOOK_AUTH: envJson.REVENUECAT_WEBHOOK_AUTH || '',
                    REVENUECAT_ALLOW_SANDBOX: envJson.REVENUECAT_ALLOW_SANDBOX || '',
                    ...
                    MICROSOFT_OAUTH_CLIENT_ID: envJson.MICROSOFT_OAUTH_CLIENT_ID || '',
                    MICROSOFT_OAUTH_CLIENT_SECRET: envJson.MICROSOFT_OAUTH_CLIENT_SECRET || '',
